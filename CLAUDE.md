...
- Use Flask-Login + werkzeug.security for any authentication work — never roll a custom flow or store plaintext passwords.
- Never add `@login_required` to existing routes unless the task explicitly asks for it.
